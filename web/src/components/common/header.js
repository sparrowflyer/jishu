                    ...
                    <nav className="navbar navbar-expand-md m-0">
                        ...
                        <div className="collapse navbar-collapse" id="main-menu">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item menu-item-has-children dropdown">
                                    <Link to="/me" className="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        个人中心
                                    </Link>
                                    <div className="dropdown-menu">
...
function NormalHeader({activeTitle}) {
    return (
        <header className="masthead">
            <div className="container">
                <div className="row">
...
export function Header({activeTitle}) {
    return (
        <div>
            { activeTitle ? <NormalHeader /> : <HomeHeader /> }
        </div>
    );
}

Header.propTypes = {
    activeTitle: PropTypes.oneOf(['home', 'course', 'blog', 'event', 'other', 'me'])
};
