                            ...
                            <div className="item">
                                <div className="item-thumb"><img src="../images/popular/1.jpg" alt="Item Thumbnail" /></div>
                                    <div className="item-details">
                                        <h3 className="item-title"><a href="course-single-01.html">The Complete Digital Marketing Course - 12 Courses in 1</a></h3>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="item">
                                    <div className="item-thumb"><img src="../images/popular/2.jpg" alt="Item Thumbnail" /></div>
                                        <div className="item-details">
                                            <h3 className="item-title"><a href="course-single-01.html">React 16 - The Complete Guide (incl. React Router 4 & Redux)</a></h3>
                                            <span className="instructor"><a href="#">Justin Marks</a></span>
                                            <div className="details-bottom">
                                                <div className="course-price float-left"><span className="currency">$</span><span className="price">15.99</span></div>
                                                <div className="rating float-right">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="item">
                                        <div className="item-thumb"><img src="../images/popular/3.jpg" alt="Item Thumbnail" /></div>
                                            <div className="item-details">
                                                <h3 className="item-title"><a href="course-single-01.html">Become A Full Stack Web Developer - Beginner To Advanced</a></h3>
                                                <span className="instructor"><a href="#">Justin Marks</a></span>
                                                <div className="details-bottom">
                                                    <div className="course-price float-left"><span className="currency">$</span><span className="price">15.99</span></div>
                                                    <div className="rating float-right">
                                    ...
                                    <div className="col-lg-4 col-md-6">
                                        <div className="item">
                                            <div className="item-thumb"><img src="../images/popular/4.jpg" alt="Item Thumbnail" /></div>
                                                <div className="item-details">
                                                    <h3 className="item-title"><a href="course-single-01.html">The Complete React Web Developer Course (with Redux)</a></h3>
                                                    <span className="instructor"><a href="#">Justin Marks</a></span>
                                                    <div className="details-bottom">
                                                        <div className="course-price float-left"><span className="currency">$</span><span className="price">15.99</span></div>
                                                        <div className="rating float-right">
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="item">
                                                <div className="item-thumb"><img src="../images/popular/5.jpg" alt="Item Thumbnail" /></div>
                                                    <div className="item-details">
                                                        <h3 className="item-title"><a href="course-single-01.html">MERN Stack Front To Back: Full Stack React, Redux & Node.js</a></h3>
                                                        <span className="instructor"><a href="#">Justin Marks</a></span>
                                                        <div className="details-bottom">
                                                            <div className="course-price float-left"><span className="currency">$</span><span className="price">15.99</span></div>
                                                            <div className="rating float-right">
                                            ...
                                            <div className="col-lg-4 col-md-6">
                                                <div className="item">
                                                    <div className="item-thumb"><img src="../images/popular/6.jpg" alt="Item Thumbnail" /></div>
                                                        <div className="item-details">
                                                            <h3 className="item-title"><a href="course-single-01.html">Learn Blockchain By Building Your Own In JavaScript language</a></h3>
                                                            <span className="instructor"><a href="#">Justin Marks</a></span>
                                                            <div className="details-bottom">
                                                                <div className="course-price float-left"><span className="currency">$</span><span className="price">15.99</span></div>
                                                                <div className="rating float-right">
                                                ...
                                                <div className="col-lg-4 col-md-6">
                                                    <div className="item">
                                                        <div className="item-thumb"><img src="../images/popular/7.jpg" alt="Item Thumbnail" /></div>
                                                            <div className="item-details">
                                                    ...
                                                    <div className="col-lg-4 col-md-6">
                                                        <div className="item">
                                                            <div className="item-thumb"><img src="../images/popular/8.jpg" alt="Item Thumbnail" /></div>
                                                                <div className="item-details">
                                                        ...
                                                        <div className="col-lg-4 col-md-6">
                                                            <div className="item">
                                                                <div className="item-thumb"><img src="../images/popular/9.jpg" alt="Item Thumbnail" /></div>
                                                                    <div className="item-details">
                                                                        <h3 className="item-title"><a href="course-single-01.html">Apache Spark Streaming with Python and PySpark</a></h3>
                                                                        <span className="instructor"><a href="#">Justin Marks</a></span>
                                                                        <div className="details-bottom">
                                                                            <div className="course-price float-left"><span className="currency">$</span><span className="price">15.99</span></div>
                                                                            <div className="rating float-right">
...
function SingleCourse() {
    return (
        <div className="row">
            <div className="col-md-8">
                <h2 className="course-title">Apache Streaming with Python and PySpark</h2>
                <div className="course-meta">
                    <span className="meta-details">
                        ...
                        <a className="name" href="#">Alex Hilfisher</a>
                    </span>
                    <span className="meta-details">
                ...
                <img className="radius" src="../images/single.jpg" alt="Course Image" />
